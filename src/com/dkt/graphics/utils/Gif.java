...
public class Gif {
    ...
    public void snapshot() {
        synchronized(canvas) {
            snapshots.add(Utils.getImage(canvas, true));
        }
    }
    ...
    public boolean write(String path) throws NullPointerException {
        ...
        BufferedImage[] images = snapshots.toArray(new BufferedImage[size()]);

        try {
            write(path, delay, images);
